...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      <h1 class="h2">Artwork Categories</h1>
    </div>
    ...
    @endif
    <a href="/dashboard/category/art/create" class="btn btn-info mb-3">Tambah Kategori Baru</a>
    <div class="bg-light">
            ...
            @foreach ($categories as $category) 
                <tr>
                    ...
                    <td>
                        ...
                        <form action="/dashboard/category/art/{{ $category->slug }}" method="post" class="d-inline">
                          @method('delete')
                          @csrf
